...
export default function Login() { 
  ...
  //Need to add a catch in case a user is deleted from user table but still exists in the authentication table
  ...
  <div className="container flex mx-auto max-w-screen-md items-center h-screen">
    <div className="flex w-3/5">
      <img src="/images/iphone-with-profile.jpg" alt="iPhone with Instagram app open" />
    </div>
    <div className="flex flex-col w-2/5">
      ...
      <div className="flex justify-center items-center flex-col w-full bg-white p-4 border border-gray-primary">
        ...
        <Link data-testid="sign-up" to={ROUTES.SIGN_UP} className="font-bold text-blue-medium">
          Sign Up
        </Link>
      </div>
    </div>
